...
class TicTacToeGame {
    ...
    // Keep reference of the connections between server and client.
    ...
    init {
        ...
        // we call broadcast function with the corresponding state.
        state.onEach(::broadcast).launchIn(gameScope)
    }

    fun connectPlayer(session: WebSocketSession): Char? {

        // First connected player is player X
    ...
    private fun getWinningPlayer(): Char? {
        ...
        return if (field[0][0] != null && field[0][0] == field[0][1] && field[0][1] == field[0][2]) {
            ...
            field[0][0]
        } else if (field[0][1] != null && field[0][1] == field[1][1] && field[1][1] == field[1][1]) {
            field[0][1]
        } else if (field[0][2] != null && field[0][2] == field[1][2] && field[1][2] == field[1][2]) {
            field[0][2]
